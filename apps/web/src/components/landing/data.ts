...
export const products: Product[] = [
  {
    ...
    features: [
      ...
      "USB tokens, smart cards, and .pfx certificates",
    ...
    faq: [
      ...
      { q: "What kinds of digital certificates does it support?", a: "SignBolt works with any X.509 digital certificate that Windows can see — USB tokens (like ePass, WatchData), smart cards, or software certificates (.pfx/.p12 files). Just plug in your token or install your certificate, and SignBolt finds it automatically." },
  ...
  },
  {
    ...
    benefits: [
      ...
      "Supports USB tokens, smart cards, and Windows certificates",
    ...
    pricing: [
      {
        ...
        features: [
          ...
          "USB token, smart card & certificate support",
    ...
    faq: [
      ...
      { q: "What types of signing hardware does SignBridge support?", a: "SignBridge works with any hardware that integrates with the Windows Certificate Store -- including USB tokens (like ePass, SafeNet, WatchData), smart cards, and software certificates stored in Windows CAPI/CNG. If Windows can see it, SignBridge can sign with it." },
